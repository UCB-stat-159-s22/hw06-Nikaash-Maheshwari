...
def plot_utils_one(time, timemax, SNR, pcolor, det, eventname, plottype):
    # -- Plot the result
...
def plot_utils_two(time, tevent, strain_whitenbp, pcolor, det, template_match, timemax, plottype, eventname):
    plt.figure(figsize=(10,8))
    plt.subplot(2,1,1)
...
def plot_utils_three(template_fft, datafreq, d_eff, freqs, data_psd, pcolor, det, fs, eventname, plottype):
